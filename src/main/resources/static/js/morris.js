(function() {
    ...
    Morris.Line = (function(_super) {
        ...
        Line.prototype.displayHoverForRow = function(index) {
            var _ref;
            if (index != null) { (_ref = this.hover).update.apply(_ref, this.hoverContentForRow(index));
    ...
    Morris.Bar = (function(_super) {
        ...
        function Bar(options) {
            ...
            Bar.__super__.constructor.call(this, $.extend({},
                options, {
                    parseTime: false
                }));
        }
